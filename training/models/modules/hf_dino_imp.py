...
class DINOv3ViTAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        patches, _ = hidden_states.size()

        query_states = self.q_proj(hidden_states)
        key_states = self.k_proj(hidden_states)
        value_states = self.v_proj(hidden_states)

        # B, P, H, d (transpose 1 2)
        query_states = query_states.view(patches, self.num_heads, self.head_dim).transpose(0, 1)
        key_states = key_states.view(patches, self.num_heads, self.head_dim).transpose(0, 1)
        value_states = value_states.view(patches, self.num_heads, self.head_dim).transpose(0, 1)
        ...
        attn_output = attn_output.reshape(patches, -1).contiguous()
...
class DINOv3ViTModel(DINOv3ViTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        hidden_states = self.embeddings(pixel_values, bool_masked_pos=bool_masked_pos).squeeze()

...
class UperNetHead(BaseCDDecoder):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.drop_cls_on_transfer = drop_cls_on_transfer
        ...
        if use_auxfcn:
            # take index 2 (layer3) or if there is less inputs, take index of last
